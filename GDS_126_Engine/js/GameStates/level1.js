...
//A platform
var plat = new GameObject({width:256, height:64,y:canvas.height-200, color:"blue"})
...
rbg.img.src=`images/mid ground.png`
...
gameStates[`level1`] = function()
{
	...
	plat.color = plat.drawStaticImage()
